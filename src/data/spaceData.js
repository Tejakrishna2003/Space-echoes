export const SPACE_DATA = {
  ...
  iss: {
    ...
    category: 'Orbital Satellite // Low Earth Orbit',
    size: 0.25,
    orbitRadius: 10.5,
    orbitSpeed: 0.04,
    tilt: 51.6,
    colorHex: '#38bdf8',
    emissiveHex: '#0284c7',
    distance: '420 km altitude (1.00 AU)',
    diameter: '109 meters',
    temp: '-157°C to 121°C',
    gravity: '0.89 g (Microgravity)',
    dayLength: '92 Minutes per Orbit',
    composition: 'Titanium, Aluminum Alloys & Solar Arrays',
    moons: '7 Astronaut Crew',
    structure: 'Truss Assembly, Pressurized Modules (Zarya, Unity, Destiny), 8 Solar Array Wings & Canadarm2',
    desc: 'The International Space Station is a modular space station in low Earth orbit, serving as a microgravity research laboratory.',
    lore: 'Orbiting Earth 16 times per day at 28,000 km/h, the ISS represents humanity’s longest continuous presence in space.'
  },
  voyager1: {
    key: 'voyager1',
    name: 'Voyager 1 Probe',
    category: 'Interstellar Probe // Deep Space',
    size: 0.35,
    orbitRadius: 110.0,
    orbitSpeed: 0.0005,
    tilt: 35.0,
    colorHex: '#fbbf24',
    emissiveHex: '#b45309',
    distance: '163.5 AU (24.4 Billion km)',
    diameter: '3.7 meter Dish Antenna',
    temp: '2.7 K (Cosmic Background)',
    gravity: 'N/A (Heliopause Escape)',
    dayLength: 'Hyperbolic Trajectory (17 km/s)',
    composition: 'Hydrazine Fuel, RTG Power Cell & Golden Record',
    moons: '1 Golden Record',
    structure: '3.7m High-Gain Dish Antenna, RTG Power Generator, Magnetometer Boom & Cosmic Ray Subsystem',
    desc: 'Humanity’s farthest human-made object, traveling through the interstellar medium outside our solar heliosphere.',
    lore: 'Launched in 1977, Voyager 1 carries the Golden Record containing greetings, sounds, and images of Earth for interstellar space.'
  }
};
